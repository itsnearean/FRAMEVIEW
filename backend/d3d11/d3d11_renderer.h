...
class d3d11_renderer : public core::renderer {
public:
    d3d11_renderer();
    ~d3d11_renderer() override;
    ...
    void draw_buffer(const core::draw_buffer* buf) override;
...
private:
    ...
    std::unique_ptr<d3d11_draw_manager> _draw_manager;
